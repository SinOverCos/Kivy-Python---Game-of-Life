...
# Ask on Stack Overflow: how to avoid re-reading image each time?

# Save stamps to file (i.e. implement function to give the stamp a name)

# Next: Make scrollable view with labels, pick/delete stamps
...
##            self.add_widget(CoreImage('Transparent.png'))
        #self.add_widget(Image(source='Transparent.png', allow_stretch=True, keep_ratio=False))
        pass
    ...
    def find_neighbour_states(self, tile_num):
        ...
        ## Correction... left and right should be flipped.
        ## I thought it was:
        ## [----->n]
        ## [------>]
        ## [0 1 -->]
    ...
    def record_stamp(self, *args):
        ...
        self.append_stamp_to_file(self.stamp, "gameoflifestamps.txt")

    def append_stamp_to_file(self, stamp, file_name):
        pass
...
class ChooseStampButton(Button):
    ...
    def on_release(self, **kwargs):
        ...
        root.ids["grid"].add_widget(Tile(1))
...
class Tile(Image):
    ...
    live_data = io.BytesIO(open("GreenFade.png", "rb").read())
    live_ext = "png"
    dead_data = io.BytesIO(open("Transparent.png", "rb").read())
    dead_ext = "png"
    
    def __init__(self, index, **kwargs):
        super(Tile, self).__init__(Tile.dead_source, ext=Tile.dead_ext, **kwargs)
    ...
    def live(self):
        ...
        self.load_memory(Tile.live_data, ext="png", filename="GreenFade.png")
    ...
    def die(self):
        ...
        self.load_memory(Tile.dead_data, ext="png", filename="Transparent.png")
...
class ViewStampButton(ListItemButton):
    ...
    ## Remember to unschedule the frames from the thumbnail when
    ## User moves away from this stamp
...
class StampViewer(GridLayout):
    ...
    def __init__(self, **kwargs):
        ...
        self.stamp_dict = {"Glider" : {"name" : "Glider",
    ...
    def list_stamps(self):
        self.add_widget(StampThumbnail(20, 20, [2, 3], [3], []))
    ...
    def read_stamps_from_file(self, stamp_file):
        ...
        for line in stamps:
            ...
            stamp_dict[stamp_name] = stamp_matrix
            self.print_binary_matrix(stamp_matrix)

        stamps.close()

        self.stamp_dict = stamp_dict ## self.stamp_dict exists for testing only
